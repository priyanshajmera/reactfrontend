...
export const categoriesByGender: Record<Gender, Category[]> = {
  male: [
    ...
    {
      name: 'Shoes',
      subcategories: ['Sneakers', 'Boots', 'Loafers', 'Formal Shoes', 'Sandals', 'Slippers']
    },
    {
      name: 'Accessories',
      subcategories: ['Hats/caps', 'Ties', 'Scarves', 'Pocket Squares']
    }
  ],
  female: [
    {
    ...
    {
      name: 'Dresses',
      subcategories: ['Casual', 'Formal', 'Evening', 'Summer', 'Party Wear', 'Maxi Dresses', 'Mini Dresses', 'Midi Dresses', 'Gowns']
    },
    {
      name: 'Outerwear',
      subcategories: ['Jackets', 'Coats', 'Sweaters', 'Sweatshirts', 'Cardigans', 'Blazers', 'Capes', 'Shrugs', 'Ponchos']
    },
    {
      name: 'Suits',
    ...
    {
      name: 'Shoes',
      subcategories: ['Heels', 'Flats', 'Sneakers', 'Boots', 'Wedges', 'Sandals', 'Slippers', 'Sports Shoes', 'Mules']
    },
    {
      name: 'Accessories',
      subcategories: ['handbags/Bags', 'Jewelry', 'Scarves', 'Sunglasses', 'Hats/caps', 'Gloves', 'Clutches']
    },
    {
      name: 'Ethnic Wear',
